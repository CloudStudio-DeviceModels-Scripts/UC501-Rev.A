...
# Parsing + Configuration Script – UC501 - Rev. A

This **Parsing + Configuration** script is designed for the **UC501** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – UC501 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **UC501** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
